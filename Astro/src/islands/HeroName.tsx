...
const HeroName: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const startTimeoutId = window.setTimeout(() => {
      // Full scramble phase: every letter rapidly cycles fonts
      ...
      // After full scramble window, begin LTR sequential settle
      window.setTimeout(() => {
        let current = 0;
        ...
        const settleStep = () => {
          if (current >= chars.length) {
            ...
            // Final lock: ensure everything is in main font
